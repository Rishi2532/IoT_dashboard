/**
 * Fix Remaining Dashboard URLs 
 * 
 * This script focuses on fixing the remaining regions' dashboard URLs
 */
...
async function fixRemainingUrls() {
  ...
  try {
    ...
    try {
      // Targeting specific regions in batches
      const targetRegions = ['Konkan', 'Nagpur', 'Nashik'];
      ...
      console.log('\nAll specified regions have been updated.');

/**
 * Fix Dashboard URLs for Nagpur Region
 * 
 * This script fixes dashboard URLs for the Nagpur region to match the exact format:
...
/**
 * Fix dashboard URLs for the Nagpur region
 */
async function fixNagpurDashboardUrls() {
...
fixNagpurDashboardUrls().catch(err => {

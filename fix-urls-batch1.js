/**
 * Fix Dashboard URLs for Batch 1 (Pune, Nashik, Konkan)
 * 
 * This script fixes dashboard URLs for the first batch of regions to match the exact format:
...
/**
 * Fix dashboard URLs for the first batch of regions (Pune, Nashik, Konkan)
 */
async function fixBatch1DashboardUrls() {
  ...
  try {
    ...
    try {
      // Define regions for Batch 1
      const regions = ['Pune', 'Nashik', 'Konkan'];
      
      console.log(`Processing Batch 1: ${regions.join(', ')}`);
      ...
      console.log('\nBatch 1 dashboard URLs have been updated to the correct format.');
...
fixBatch1DashboardUrls().catch(err => {

          ...
          <div className="w-full overflow-x-auto flex-1 min-h-[480px]">
            <div className="min-w-[280px] sm:min-w-full h-full">
              ...
              >
                ...
                <div className="h-full w-full flex items-center justify-center overflow-hidden bg-blue-50/30 rounded-lg p-2">
                  <div className="transform scale-[0.16] origin-center">
                    <Maharashtra 

...
export default function Regions() {
  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-neutral-900">Regions Overview</h1>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-sm font-medium">
                          {region.fully_completed_esr || 0} / {region.total_esr || 0}
                        </span>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-sm font-medium">
                          {region.fully_completed_villages || 0} / {region.total_villages || 0}
                        </span>
                      </div>
                      <div className="w-full bg-neutral-200 rounded-full h-2">
                        <div 
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-sm font-medium">
                          {region.fully_completed_schemes || 0} / {region.total_schemes || 0}
                        </span>
                      </div>
                      <div className="w-full bg-neutral-200 rounded-full h-2">
                        <div 

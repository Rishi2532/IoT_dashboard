  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:gap-4 md:gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <Card className="bg-white overflow-hidden border border-blue-100 hover:shadow-md transition-all duration-300 hover:translate-y-[-2px]">
        <div className="absolute top-0 right-0 h-16 w-16 sm:h-20 sm:w-20 opacity-10">
          <BarChart3 className="h-full w-full text-blue-700" />
        </div>
        <CardContent className="p-3 sm:p-4 md:p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg p-2 sm:p-3 shadow-sm">
              <GitBranchPlus className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-white" />
            </div>
            <div className="ml-3 sm:ml-4 md:ml-5 flex-1">
              ...
              <div className="mt-1 flex items-baseline">
                ...
                <p className="ml-1 sm:ml-2 text-xs sm:text-sm text-blue-600">schemes</p>
              </div>
            </div>
          </div>
          <div className="mt-3 sm:mt-4 md:mt-6">
            ...
            <div className="w-full bg-blue-100 rounded-full h-2 sm:h-3 mt-1 sm:mt-2 overflow-hidden">
              <div
                className="bg-gradient-to-r from-blue-500 to-blue-600 h-2 sm:h-3 rounded-full shadow-inner"
                style={{ width: `${schemeCompletionPercentage}%` }}
              ></div>
            </div>
            <div className="flex justify-between text-[10px] sm:text-xs mt-1">
              <span className="text-blue-600">
                <b>{completedSchemes} Completed</b>
              </span>
              <span className="text-violet-600">
                {totalSchemes - completedSchemes} Partial
              </span>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="bg-white overflow-hidden border border-amber-100 hover:shadow-md transition-all duration-300 hover:translate-y-[-2px]">
        ...
        <CardContent className="p-3 sm:p-4 md:p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0 bg-gradient-to-br from-amber-500 to-amber-600 rounded-lg p-2 sm:p-3 shadow-sm">
              <Home className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-white" />
            </div>
            <div className="ml-3 sm:ml-4 md:ml-5 flex-1">
              ...
              <div className="mt-1 flex items-baseline">
                <p className="text-xl sm:text-2xl md:text-3xl font-bold text-amber-900">
                  {totalVillages}
                </p>
                <p className="ml-1 sm:ml-2 text-xs sm:text-sm text-amber-600">
                  villages
                </p>
              </div>
            </div>
          ...
          <div className="mt-3 sm:mt-4 md:mt-6">
            ...
            <div className="w-full bg-amber-100 rounded-full h-2 sm:h-3 mt-1 sm:mt-2 overflow-hidden">
              <div
                className="bg-gradient-to-r from-amber-500 to-amber-600 h-2 sm:h-3 rounded-full shadow-inner"
                style={{ width: `${villageCompletionPercentage}%` }}
              ></div>
            </div>
            <div className="flex justify-between text-[10px] sm:text-xs mt-1">
              <span className="text-amber-600">
                <b>{completedVillages} Completed</b>
              </span>
              <span className="text-amber-600">
                {totalVillages - completedVillages} Partial
              </span>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="bg-white overflow-hidden border border-sky-100 hover:shadow-md transition-all duration-300 hover:translate-y-[-2px]">
        ...
        <CardContent className="p-3 sm:p-4 md:p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0 bg-gradient-to-br from-sky-500 to-sky-600 rounded-lg p-2 sm:p-3 shadow-sm">
              <Droplet className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-white" />
            </div>
            <div className="ml-3 sm:ml-4 md:ml-5 flex-1">
              <h3 className="text-xs sm:text-sm font-medium text-sky-800">Total ESR</h3>
              <div className="mt-1 flex items-baseline">
                <p className="text-xl sm:text-2xl md:text-3xl font-bold text-sky-900">{totalEsr}</p>
                <p className="ml-1 sm:ml-2 text-xs sm:text-sm text-sky-600">ESRs</p>
              </div>
            </div>
          </div>
          <div className="mt-3 sm:mt-4 md:mt-6">
            ...
            <div className="w-full bg-sky-100 rounded-full h-2 sm:h-3 mt-1 sm:mt-2 overflow-hidden">
              <div
                className="bg-gradient-to-r from-sky-500 to-sky-600 h-2 sm:h-3 rounded-full shadow-inner"
                style={{ width: `${esrCompletionPercentage}%` }}
              ></div>
            </div>
            <div className="flex justify-between text-[10px] sm:text-xs mt-1">
              <span className="text-sky-600">
                <b>{completedEsr} Completed</b>
              </span>
              <span className="text-sky-600">
                {totalEsr - completedEsr} Partial
              </span>
            </div>
          </div>
        </CardContent>

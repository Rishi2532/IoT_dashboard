  ...
  return (
    <Card className="w-full max-w-4xl">
      <CardHeader>
        ...
        <CardDescription>
          Import data from CSV files without headers by mapping columns to database fields.
        </CardDescription>
      </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="scheme_status">Scheme Status</SelectItem>
              ...
              {tableName === 'scheme_status' && (
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    If set, this region will be used for records that don't have a region specified.
                  </p>
                </div>
              )}

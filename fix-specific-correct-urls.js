/**
 * Fix specific scheme dashboard URLs to use the correct format
 * 
 * This script targets a few specific schemes to update their dashboard URLs using the correct format:
...
/**
 * Main function to fix specific scheme dashboard URLs
 */
  ...
  try {
    ...
    try {
      ...
      for (const schemeInfo of schemesToFix) {
        ...
        // Generate the new URL with the correct format

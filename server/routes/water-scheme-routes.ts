    ...
    try {
      let baseQuery = `
        ...
        SELECT 
          ...
          -- Population change analysis (day6 vs day5) - Simple difference calculation  
          SUM(CASE WHEN water_value_day6 != 0 AND water_value_day6 IS NOT NULL THEN population ELSE 0 END) - SUM(CASE WHEN water_value_day5 != 0 AND water_value_day5 IS NOT NULL THEN population ELSE 0 END) as population_gained_water,
          SUM(CASE WHEN water_value_day6 = 0 THEN population ELSE 0 END) - SUM(CASE WHEN water_value_day5 = 0 THEN population ELSE 0 END) as population_lost_water,

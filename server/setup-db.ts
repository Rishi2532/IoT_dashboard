  ...
  try {
    ...
    await db.execute(`
      CREATE TABLE IF NOT EXISTS "chlorine_data" (
        ...
        "village_name" TEXT,
        "esr_name" TEXT,
        "Chlorine_value_1" DECIMAL(12,2),
        "Chlorine_value_2" DECIMAL(12,2),
        "Chlorine_value_3" DECIMAL(12,2),
        "Chlorine_value_4" DECIMAL(12,2),
        "Chlorine_value_5" DECIMAL(12,2),
        "Chlorine_value_6" DECIMAL(12,2),
        "Chlorine_value_7" DECIMAL(12,2),
